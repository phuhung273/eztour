...
<script>
    function modalGo(id){
        Swal.fire({
            ...
            icon: 'question',
            text: 'Are you sure to go on this tour?',
            showCancelButton: true,
            confirmButtonText: 'Yes, going on it'
        }).then((result) => {
    ...
    function modalView(id){
        Swal.fire({
            ...
            icon: 'question',
            text: 'You will only view - not going on this tour ?',
            showCancelButton: true,
            confirmButtonText: 'Yes, I want to review it'
        }).then((result) => {
            if (result.isConfirmed) {
