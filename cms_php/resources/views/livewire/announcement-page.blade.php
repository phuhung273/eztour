...
<x-base-team-page :viewingTeam="$viewingTeam">
    <div x-data="announcementPage()" class="grid grid-cols-1 md:grid-cols-3 gap-y-4 gap-x-16">
        ...
        <div class="col-span-2">
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md">
                ...
                <x-announcement-table :data="$data" :options="$categories" />
            </div>
        </div>
    </div>
    ...
    function announcementPage() {
        return {
            ...
            modalUpdate(id){
                ...
                updateCategory.value = row.announcement_category_id
                this.openModal()
            },
            submitCreate(){
                const self = this;
